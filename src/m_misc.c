...
//#endif
  ...
  {"screenblocks",{&screenblocks},{10},3,11,  // killough 2/21/98: default to 10
   def_int,ss_none},
  {"usegamma",{&usegamma},{1},0,4, //jff 3/6/98 fix erroneous upper limit in range
  ...
  {"gl_colorbuffer_bits",{&gl_colorbuffer_bits},{32},16,32,
   def_int,ss_none},
  {"gl_depthbuffer_bits",{&gl_depthbuffer_bits},{32},16,32,
   def_int,ss_none},
...
// CPhipps - now they're the doom codes, so default.cfg can be portable
  ...
  {"key_straferight", {&key_straferight},    {0x7f}           ,
   0,MAX_KEY,def_key,ss_keys}, // key to strafe right

  {"key_fire",        {&key_fire},           {0x9d}     ,
...
//e6y
  ...
  {"Prboom-plus game settings",{NULL},{1},UL,UL,def_none,ss_none},
  ...
  {"Prboom-plus misc settings",{NULL},{1},UL,UL,def_none,ss_none},
